    ...
    class Server
    {
        ...
        private void receive()
        {
            while (true)
            {
                ...
                server_sock.Receive(buffer_receive,buffer_receive.Length,SocketFlags.None);
                Callback();
            }
        }
        private void Callback()
        {
            ...
            received_message = received_message.Replace("\0", string.Empty);
        ...
        private void send()
        {
            while (true)
            {
                ...
                server_sock.SendTo(buffer_send, 0, buffer_send.Length, SocketFlags.None, remote_ipe);
            }
